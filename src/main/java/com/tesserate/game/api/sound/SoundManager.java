...
import com.tesserate.game.api.util.ThreadPool;
...
public class SoundManager extends ThreadPool {
	...
	public static SoundManager getInstance() {
		if (SoundManager.instance == null) {
			SoundManager.instance = new SoundManager(PLAYBACK_FORMAT);
		}
	 ...
	 */
	public Sound getSound(String id, String filename) {
		return getSound(id, getAudioInputStream(filename));
	}

	/**
	 * Loads a Sound from an input stream. Returns null if an error occurs.
	 */
	public Sound getSound(String id, InputStream is) {
		return getSound(id, getAudioInputStream(is));
	}

	/**
	 * Loads a Sound from an AudioInputStream.
	 */
	public Sound getSound(String id, AudioInputStream audioStream) {
		if (audioStream == null) {
			return null;
		}
		...
		// return the samples
		Sound sound = new Sound(id, samples);
		return sound;
	}
